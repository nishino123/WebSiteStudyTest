...
def main():
    ...
    for i in range(1000):
        try:
            url_List = 'http://mobile.nmpa.gov.cn/datasearch/QueryList?tableId=26&searchF=Quick%20SearchK&pageIndex={}&pageSize=1000'.format(i)
            ...
            for result in res:
                Id = result['ID']
                url_Detail = 'http://mobile.nmpa.gov.cn/datasearch/QueryRecord?tableId=26&searchF=ID&searchK=%s' % Id
